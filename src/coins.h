...
/** 
    ...
    ****Note - for Gash we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of gash coming in to a transaction

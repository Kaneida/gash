...
*/
	...
	vSeeds.push_back(CDNSSeedData("node1", "node1.gashcore.com"));
        vSeeds.push_back(CDNSSeedData("node2", "node2.gashcore.com"));
        vSeeds.push_back(CDNSSeedData("node3", "node3.gashcore.com"));
        ...
        strObfuscationPoolDummyAddress = "GashcoinDarksendPoo1DummyAdy4viSr";
...
public:
    CTestNetParams()
    {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("1", "testnet.seeder.baseserv.com")); // Gash's official testseed 1
        vSeeds.push_back(CDNSSeedData("2", "testnet.seeder.uksafedns.net")); // Gash's official testseed 2
        // Testnet Gash addresses start with 'g'
...
public:
    CRegTestParams()
    {
        ...
        genesis.nNonce = 0x496f6e;                // hex 57 47 52 in text = GASH

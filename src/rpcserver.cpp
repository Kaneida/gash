...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Gash features */
        {"gash", "masternode", &masternode, true, true, false},
        {"gash", "listmasternodes", &listmasternodes, true, true, false},
        {"gash", "getmasternodecount", &getmasternodecount, true, true, false},
        {"gash", "masternodeconnect", &masternodeconnect, true, true, false},
        {"gash", "masternodecurrent", &masternodecurrent, true, true, false},
        {"gash", "masternodedebug", &masternodedebug, true, true, false},
        {"gash", "startmasternode", &startmasternode, true, true, false},
        {"gash", "createmasternodekey", &createmasternodekey, true, true, false},
        {"gash", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"gash", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"gash", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"gash", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"gash", "getmasternodescores", &getmasternodescores, true, true, false},
        {"gash", "mnbudget", &mnbudget, true, true, false},
        {"gash", "preparebudget", &preparebudget, true, true, false},
        {"gash", "submitbudget", &submitbudget, true, true, false},
        {"gash", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"gash", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"gash", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"gash", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"gash", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"gash", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"gash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"gash", "checkbudgets", &checkbudgets, true, true, false},
        {"gash", "mnsync", &mnsync, true, true, false},
        {"gash", "spork", &spork, true, true, false},
        {"gash", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"gash", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> gash-cli " + methodname + " " + args + "\n";
}

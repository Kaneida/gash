 ...
 */
    ...
    typeWidget->addItem(tr("Received Gash from xGASH"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in xGASH"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_xGASH));

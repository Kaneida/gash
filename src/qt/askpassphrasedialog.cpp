                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    if (context == Context::Unlock_Menu || context == Context::Mint_xGASH || context == Context::BIP_38) {
    ...
    // It doesn't make sense to show the checkbox for sending Gash because you wouldn't check it anyway.
    if (context == Context::Send_GASH || context == Context::Send_xGASH) {
...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm wallet encryption"),
            tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR GASH</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
            ...
            if (newpass1 == newpass2) {
                if (model->setWalletEncrypted(true, newpass1)) {
                    QMessageBox::warning(this, tr("Wallet encrypted"),
                        "<qt>" +
                            tr("GASH will close now to finish the encryption process. "
                               "Remember that encrypting your wallet cannot fully protect "
                               "your GASHs from being stolen by malware infecting your computer.") +
                            "<br><br><b>" +

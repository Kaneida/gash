...
/* gash GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "GASH"
#define QAPP_ORG_DOMAIN "gash-coin.com"
#define QAPP_APP_NAME_DEFAULT "Gash-Qt"
#define QAPP_APP_NAME_TESTNET "Gash-Qt-testnet"

                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Gash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Gash address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and gash: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for xGASH"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Gash Core"), this);
    aboutAction->setStatusTip(tr("Show information about Gash Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GASH"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Gash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Gash addresses"));
    ...
    openAction->setStatusTip(tr("Open a GASH: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Gash Core help message to get a list with possible Gash command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Gash Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Gash network", "", count));
}
...
{
    QString strTitle = tr("Gash Core"); // default title

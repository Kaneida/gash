...
/*
    ...
    result.push_back(Pair("xGASHsupply", xionObj));
*/
    return result;
}
...
UniValue getrawmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "    \"fee\" : n,              (numeric) transaction fee in gash\n"
...
UniValue gettxout(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "     \"addresses\" : [          (array of string) array of gash addresses\n"
            "     \"gashaddress\"   	 	(string) gash address\n"
            "        ,...\n"
            "     ]\n"
            "  },\n"

...
#   c) node1 mines 32 blocks, so now node 0 has 60001gash, node 1 has 4250gash, node2 has none.
#   d) node0 sends 601 gash to node2, in two transactions (301 gash, then 300 gash).

Contributing to Gash Core
============================

The Gash Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Gash Core project, and is not to be
confused with overall Gash Network Protocol consensus changes.

Whether a pull request is merged into Gash Core rests with the project merge
...
Patches that change Gash consensus rules are considerably more involved than
...
Where a patch set proposes to change the Gash consensus, it must have been
...
The project leader is the release manager for each Gash Core release.

...
RESOURCES += src/qt/gash.qrc src/qt/gash_locale.qrc

TRANSLATIONS += src/qt/locale/gash_bg.ts \
                src/qt/locale/gash_de.ts \
                src/qt/locale/gash_en.ts \
                src/qt/locale/gash_es.ts \
                src/qt/locale/gash_fi.ts \
                src/qt/locale/gash_fr.ts \
                src/qt/locale/gash_it.ts \
                src/qt/locale/gash_ja.ts \
                src/qt/locale/gash_pl.ts \
                src/qt/locale/gash_pt.ts \
                src/qt/locale/gash_ru.ts \
                src/qt/locale/gash_sk.ts \
                src/qt/locale/gash_sv.ts \
                src/qt/locale/gash_vi.ts \
                src/qt/locale/gash_zh_CN.ts \
                src/qt/locale/gash_zh_TW.ts

...
###   This script attempts to download the signature file SHA256SUMS.asc from gashcore.xyz
...
SIGNATUREFILE="https://gashcore.xyz/bin/3.0.4.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://gashcore.xyz/bin/"

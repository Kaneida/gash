...
In order to support loading of multiple wallets in gash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is gash.cpp.
...
Changes to gash.cpp
----------------------
gash.cpp is the entry point into gash-qt, and as such, will require some minor modifications to provide hooks for
